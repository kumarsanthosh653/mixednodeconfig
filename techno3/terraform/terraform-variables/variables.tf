...
variable "fargate_profile_name" {
  ...
  default     = "kube-system-profile"
}

variable "additional_fargate_profile_name" {
  description = "The name of the Santhosh Fargate profile"
  default     = "additional-profile"
}

variable "custom_node_group_name" {
  description = "The name of the custom EKS node group"
  default     = "node-group"
}

variable "namespace" {
  description = "The name of namespace"
  default     = "additional-namespace"
}
